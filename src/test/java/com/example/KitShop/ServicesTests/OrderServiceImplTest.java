...
public class OrderServiceImplTest {
    ...
    void setUp() {
        ...
        order.setOrderItems(new ArrayList<>()); // Fix null list
        ...
        orderItemDTO = new OrderItemDTO(600L, 500L, "M",14);
    ...
    void testBuyProduct_Success() {
        ...
        OrdersDTO result = orderService.buyProduct(1L, 100L, "M", 2, "Test Address");
