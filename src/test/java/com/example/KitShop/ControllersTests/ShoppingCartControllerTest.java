...
public class ShoppingCartControllerTest {
    ...
    void setUp() {
        ...
        cartItemDTO = new CartItemDTO(200L, 100L,  "M",14);
    }

    @Test
    void testAddProductToCart_Success() throws Exception {
        when(shoppingCartServiceImpl.addProductToCart(1L, 100L, "M",14)).thenReturn(shoppingCartDTO);
        ...
        verify(shoppingCartServiceImpl).addProductToCart(1L, 100L, "M",14);
    }
